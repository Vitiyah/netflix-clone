...
const Tabs = () => {
  ...
  return (
    <>
      <div className="tabheads flex flex-col items-center w-full">
        <div className="tablists w-full h-[12rem] bg-zinc-900 grid grid-cols-3 place-items-center">
          <div
            className="tabs w-full h-full flex flex-col items-center justify-center focus:border-b-4 focus:border-b-red-600 gap-8 cursor-pointer p-4"
            tabIndex="1"
            onClick={() => {
              setIndex(1);
            }}
          >
            <FaDoorOpen size={50} className="icon text-gray-400 text-center" />
            <p className="text-gray-400 text-center">Cancel at any time</p>
          </div>
          <div
            className="tabs w-full h-full flex flex-col items-center justify-center focus:border-b-4 focus:border-b-red-600 gap-8 cursor-pointer p-4"
            tabIndex="2"
          ...
          >
            <BsPhone size={50} className="icon text-gray-400 text-center" />
            <p className="text-gray-400 text-center">Watch anywhere</p>
          </div>
          <div
            className="tabs w-full h-full flex flex-col items-center justify-center focus:border-b-4 focus:border-b-red-600 gap-8 cursor-pointer p-4"
            tabIndex="3"
          ...
          >
            <IoMdPricetags
              size={50}
              className="icon text-gray-400 text-center"
            />
            <p className="text-gray-400 text-center">Pick your price</p>
          </div>
        </div>
        <div className="tabcontent" hidden={index !== 1}>
          <div className="content-1 w-full h-[40rem] p-8 flex items-center justify-around max-md:flex-col max-sm:mt-0">
            <div className="content-1-text">
              ...
              <Link
                to="/netflixshow"
                className="bg-red-600 w-[18rem] h-[3rem] flex items-center justify-center mt-12 max-sm:m-auto max-sm:mt-12"
              >
